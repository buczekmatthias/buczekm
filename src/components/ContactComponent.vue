<template>
  <div class="fixed -bottom-16 left-1/2 -translate-x-1/2 rounded-lg bg-dark px-8 py-4 duration-150" ref="toast">
...
export default {
  ...
  methods: {
    showToast(event) {
      ...
      setTimeout(() => {
        this.$refs.toast.classList.replace("bottom-8", "-bottom-16");
      }, 2000);
    },
  },
};
